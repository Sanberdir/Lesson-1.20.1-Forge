package ru.sanberdir.lesson_1_20_1_forge.items.armor;
...
public enum ModArmorMaterials implements ArmorMaterial {
    SAPPHIRE("sapphire", 26, new int[]{ 5, 7, 5, 4 }, 25,
            SoundEvents.ARMOR_EQUIP_GOLD, 1f, 0f, () -> Ingredient.of(InitItems.CALCINE.get()));
    ...
    public String getName() {
        return LessonForge1201.MODID + ":" + this.name;
    }
