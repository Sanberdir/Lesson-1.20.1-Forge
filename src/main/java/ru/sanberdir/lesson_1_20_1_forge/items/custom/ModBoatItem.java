package ru.sanberdir.lesson_1_20_1_forge.items.custom;
...
public class ModBoatItem extends Item {
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (hitresult.getType() == HitResult.Type.MISS) {
            ...
            if (hitresult.getType() == HitResult.Type.BLOCK) {
                ...
                } else if(boat instanceof ModBoatEntityUsual) {
                    ((ModBoatEntityUsual)boat).setVariant(this.type);
                }
    ...
    private Boat getBoat(Level level, HitResult hitResult) {
        return (Boat)(this.hasChest ? new ModChestBoatEntityUsual(level, hitResult.getLocation().x, hitResult.getLocation().y, hitResult.getLocation().z) :
                new ModBoatEntityUsual(level, hitResult.getLocation().x, hitResult.getLocation().y, hitResult.getLocation().z));
    }
}