package ru.sanberdir.lesson_1_20_1_forge.world.portal;
...
import ru.sanberdir.lesson_1_20_1_forge.blocks.custom.ModPortalBlock;
...
public class ModTeleporter implements ITeleporter {
    ...
    public Entity placeEntity(Entity entity, ServerLevel currentWorld, ServerLevel destinationWorld,
        ...
        if (insideDimension) {
            ...
            if (doSetBlock) {
                destinationWorld.setBlock(destinationPos, InitBlocks.DICE_BLOCK.get().defaultBlockState(), 3);
            }
        }
